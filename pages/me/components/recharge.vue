	...
	<view>
		<uni-popup ref="popup" borderRadius="20 20 0 0 " type="center">
			<view class="popup-content">
				...
				<view class="title">
					<text v-if="type==1">USDT-TRC20</text>
					<text v-if="type==2">USDT-BNB Smart Chain/BEP20</text>
				</view>
				<view class="form">
					<view class="form-item">
						<input  v-if="type==1" v-model="formData.text" type="text" placeholder="USDT-TRC20">
						<input  v-if="type==2" v-model="formData.text" type="text" placeholder="USDT-BNB Smart Chain/BEP20">
					</view>
					<!-- <view class="form-item">
	...
	export default {
		...
		methods: {
			...
			async submitBtn(){
				let obj = {};
				if(this.type==1){
					obj.trc20_address=this.formData.text;
				}else {
